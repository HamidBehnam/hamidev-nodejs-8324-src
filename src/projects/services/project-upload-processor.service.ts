...
class ProjectUploadProcessorService {
    ...
    async process(projectId: string, userId: string, file: Express.Multer.File, requiredRole: ProjectOperationRole, fileCategory: FileCategory, error: any): Promise<FileUploadResult> {
